...
require_once '../lib/snackoti.lib.php';
//require_once "../class/myclass.class.php";

// Translations
$langs->loadLangs(array("admin", "snackoti@snackoti"));
...
print load_fiche_titre($langs->trans($page_name), $linkback, 'object_snackoti@snackoti');

// Configuration header
$head = snackotiAdminPrepareHead();
dol_fiche_head($head, 'settings', '', -1, "snackoti@snackoti");
